...
import { createArgument, createDebate, createTag, createTicket, createUser } from '../helpers/factories';
...
describe('ModeratorService integration', () => {
  ...
  it('returns the assigned debate to the moderator', async () => {
    const debate = await service.getDebateAsModerator(
      { id: moderatorId, username: 'moderator-one', role: 'MODERATOR' as never },

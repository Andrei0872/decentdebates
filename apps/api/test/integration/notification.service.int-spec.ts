...
import {
  getNotificationIdsForRecipient,
  getNotificationRecipientIdsByTitle,
...
describe("NotificationService integration", () => {
  ...
  it("adds a notification to the other ticket participant", async () => {
    ...
    const moderatorNotifications = await getNotificationsByTitle(
      pool,
  ...
  it("adds the same notification to all moderators", async () => {
    ...
    const recipients = await getNotificationRecipientIdsByTitle(
      pool,
      "Global moderator notification",
    );

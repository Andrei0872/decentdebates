...
function NotificationWidget() {
  ...
  useEffect(() => {
    const notifSource = new EventSource(
      `${process.env.NEXT_PUBLIC_API_SERVER_URL}/notification/count`,
  ...
  const handleInteraction = (nextState: boolean) => {
    ...
    if (!nextState) {
      setTimeout(() => {
        setNotifications(
          notifications.map((n) => ({ ...n, isMerelyRead: false })),
        );
      }, 100);
      return;
    }
    ...
    <div>
      <Popover
              ...
              {notifications.map((n) => (
                ...
                >
                  ...
                  <RichEditor
                    ...
                    configOptions={{ editable: false, editorState: n.content }}
                  />
                </li>
              ))}
            </ul>
        ...
        renderTarget={({ ref, ...targetProps }) => (
          <span
            {...targetProps}
            className={`${styles.bellContainer} ${targetProps.className}`}
            ref={ref}
          >

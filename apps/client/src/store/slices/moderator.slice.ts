...
export const moderatorSlice = createSlice({
  ...
  reducers: {
    setActivityPreviewedCard(
      state,
      action: PayloadAction<ModeratorActivity | null>,
    ) {
      state.activity.previewedCard = action.payload;
    },
    setActivityPreviewedCardArgument(
      state,
      action: PayloadAction<ModeratorActivityArgument | null>,
    ) {
      state.activity.previewedCard = action.payload;
    },
    setActivityPreviewedCardDebate(
      state,
      action: PayloadAction<ModeratorActivityDebate | null>,
    ) {
      state.activity.previewedCard = action.payload;
    },
  },
...
export const selectPreviewedCard = (s: RootState) =>
  s.moderator.activity.previewedCard;

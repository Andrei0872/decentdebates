...
export async function seed(knex: Knex): Promise<void> {
  ...
  const debateIds = await knex("debate").insert(
    [
      {
        ticket_id: ticketsIds[0].id,
        title: "An interesting topic#1",
        created_by: user.id,
      },
      {
        ticket_id: ticketsIds[1].id,
        title: "An interesting topic#2",
        created_by: user.id,
      },
      {
        ticket_id: ticketsIds[2].id,
        title: "An interesting topic#3",
        created_by: user.id,
      },
      {
        ticket_id: ticketsIds[3].id,
        title: "An interesting topic#4",
        created_by: user.id,
      },
      {
        ticket_id: ticketsIds[4].id,
        title: "An interesting topic#5",
        created_by: user.id,
      },

      {
        ticket_id: ticketsIds[5].id,
        title: "pending topic#1",
        created_by: user.id,
      },
      {
        ticket_id: ticketsIds[6].id,
        title: "pending topic#2",
        created_by: user.id,
      },

      {
        ticket_id: ticketsIds[7].id,
        title: "in review topic#1",
        created_by: user.id,
      },
    ],
    ["id"],
  ...
  const tags = await knex("debate_tag").insert(
    [{ name: "history" }, { name: "community" }, { name: "health" }],
    ["id"],
  );
  ...
  await knex("argument").insert(
    [
      {
        debate_id: debateIds[0].id,
        ticket_id: argTickets[0].id,
        title: "Pro#1",
        content: longText,
        created_by: user.id,
        type: "PRO",
